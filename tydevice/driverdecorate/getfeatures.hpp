...
int getfeatures()
{
	...
	/*TY_CAMERA_INTRINSIC* p = (TY_CAMERA_INTRINSIC*)buffer;
	cv::FileStorage fs("depth_intrinsics.yml", cv::FileStorage::WRITE);
	cv::Mat M1=(cv::Mat_<double>(3,3) << p->data[0],p->data[1],p->data[2],p->data[3],p->data[4],p->data[5],p->data[6],p->data[7],p->data[8]);
	fs << "M1" << M1;
	DUMP_FEATURE(handle, 0x00010000, TY_STRUCT_CAM_DISTORTION );
	TY_CAMERA_DISTORTION* p2 = (TY_CAMERA_DISTORTION*)buffer;
	cv::Mat D1=(cv::Mat_<double>(3,4) << p2->data[0],p2->data[1],p2->data[2],p2->data[3],p2->data[4],p2->data[5],p2->data[6],p2->data[7],p2->data[8],p2->data[9],p2->data[10],p2->data[11]);
	fs<< "D1"<<D1;
	fs.release();
	*/
	...
	cv::Mat M1=(cv::Mat_<double>(3,3) << p->data[0],p->data[1],p->data[2],p->data[3],p->data[4],p->data[5],p->data[6],p->data[7],p->data[8]);
	fs << "M1" << M1;
	DUMP_FEATURE(handle, 0x00100000, TY_STRUCT_CAM_DISTORTION );
	TY_CAMERA_DISTORTION* p2 = (TY_CAMERA_DISTORTION*)buffer;
	cv::Mat D1=(cv::Mat_<double>(3,4) << p2->data[0],p2->data[1],p2->data[2],p2->data[3],p2->data[4],p2->data[5],p2->data[6],p2->data[7],p2->data[8],p2->data[9],p2->data[10],p2->data[11]);
	fs<< "D1"<<D1;
	fs.release();
